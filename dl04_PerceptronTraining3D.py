...
plane_surface = [None]  # to keep reference to the surface
...
ani = FuncAnimation(fig, update, frames=len(weight_history), interval=200, blit=False)

# ------------------- Step 4: Save animation -------------------
ani.save("dl04_perceptron_training_3D_fixed.gif", writer=PillowWriter(fps=10))
plt.close(fig)
